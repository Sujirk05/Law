  ...
  return (
    <section>
      ...
      <div className="relative h-[50vh] min-h-[400px] text-white">
        ...
        <motion.div
          className="absolute inset-0 flex flex-col items-center justify-center -translate-y-4 px-4"
          ...
          <div>
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                At Incredible Law Chamber, we deliver exceptional legal services
                with integrity, professionalism, and a client-centered
                approach.
              </p>
              ...
              <button className="mt-6 bg-yellow-500 text-black px-6 py-4 rounded-xl font-semibold hover:bg-yellow-400 hover:scale-105 transition duration-300 shadow-lg">
