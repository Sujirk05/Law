...
function About() {
  return (
    <section id="About"className="w-full py-20 px-10 bg-gray-300 scroll-mt-24 overflow-hidden" >
...
><div className="relative w-96 h-80">
           <div className=" absolute top-0 left-1/2 -translate-x-1/2 w-40 h-40  rounded-full bg-yellow-50 border-2 border-yellow-500 shadow-xl flex flex-col items-center justify-center">
  ...
  Years of Experience
                   ...
                   <div className=" absolute bottom-0 left-0  w-40 h-40 rounded-full bg-yellow-50 border-2 border-yellow-500 shadow-xl flex flex-col items-center justify-center">
  <h3 className="text-4xl font-bold text-yellow-500">500+</h3>
  <p className="text-center text-sm px-3">cases handled</p>
</div>
          <div className=" absolute bottom-0 right-0 w-40 h-40 rounded-full bg-yellow-50 border-2 border-yellow-500 shadow-xl flex flex-col items-center justify-center">
