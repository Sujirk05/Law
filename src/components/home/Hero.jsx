...
function Hero() {
  return (
    ...
    <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/45 to-black/30"></div>
        ...
        <div className="relative z-10 md:h-full flex items-start md:items-center pt-20 md:pt-0">
 ...
 <div className="max-w-2xl">
          ...
          <h1
            ...
            {/* Secondary Text */}
            <p
              className="mt-4 lg:mt-5 text-sm sm:text-base lg:text-lg text-gray-300 leading-7 lg:leading-8"   >
