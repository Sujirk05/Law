...
function Test() {
  ...
  return (
    <section
      id="Test"
      className="bg-gradient-to-r from-slate-950 via-gray-900 to-black py-20 px-6 overflow-hidden"
    >
      {/* Heading */}
      <div className="text-center mb-14">
        ...
        <h2 className="text-gray-300 mt-2 text-xl">
      ...
      <div className="flex justify-center">
        <div className="relative w-[1250px] pb-20">
          {/* Previous Button */}
          <button
            onClick={prevSlide}
